...
const RedisService = function () {
    this.$id = 'logic_RedisService';
    this.app = null;
    this._asyncRedis = null;
};

module.exports = RedisService;
bearcat.extend('logic_RedisService', 'logic_BaseService');

/**
 * 初始化redis client
 */
RedisService.prototype.init = async function () {
    const redisConfig = this.app.SystemConfig.redis;
 ...
 * @return OK/null
 */
RedisService.prototype.set = async function (key, value, ...param) {
 ...
 */
RedisService.prototype.get = async function (key) {
 ...
 * @return 成功删除条目
 */
RedisService.prototype.del = async function (...keys) {
 ...
 * @return 成功删除条目
 */
RedisService.prototype.delDirect = async function (...keys) {
 ...
 */
RedisService.prototype.keys = async function (pattern)  {
 ...
 * @return 增加后的值
 */
RedisService.prototype.incrby = async function (key, incr = 1) {
 ...
 * @return 减去后的值
 */
RedisService.prototype.decrby = async function (key, incr = 1) {
 ...
 * @return 增加后的值
 */
RedisService.prototype.incrbyfloat = async function (key, incr = 1) {
 ...
 * @return 1/0
 */
RedisService.prototype.exists = async function (key) {
 ...
 * @return 1/0
 */
RedisService.prototype.expire = async function (key, seconds) {
 ...
 * @return 1/0
 */
RedisService.prototype.pexpire = async function (key, milliseconds) {
 ...
 * @return 1/0
 */
RedisService.prototype.expireat = async function (key, timestamp) {
 ...
 * @return 1/0
 */
RedisService.prototype.pexpireat = async function (key, milliseconds) {
 ...
 * @return 1/0
 */
RedisService.prototype.persist = async function (key) {
 ...
 */
RedisService.prototype.multi = async function (list) {
 ...
 * @return OK
 */
RedisService.prototype.watch = async function (...keys) {
 ...
 * @return OK
 */
RedisService.prototype.unwatch = async function () {
 ...
 * @return 当前列表长度
 */
RedisService.prototype.lpush = async function (key, ...values) {
 ...
 * @return 当前列表长度
 */
RedisService.prototype.rpush = async function (key, ...values) {
 ...
 * @return 并返回被弹出的值
 */
RedisService.prototype.lpop = async function (key) {
 ...
 * @return 并返回被弹出的值
 */
RedisService.prototype.rpop = async function (key) {
 ...
 * @return 并返回给定位置的值
 */
RedisService.prototype.lindex = async function (key, index) {
 ...
 * @return 列表/[]
 */
RedisService.prototype.lrange = async function (key, start, end) {
 ...
 * @return 列表
 */
RedisService.prototype.ltrim = async function (key, start, end) {
 ...
 * @return 列表长度
 */
RedisService.prototype.llen = async function (key) {
 ...
 * @return 插入元素数量
 */
RedisService.prototype.sadd = async function (key, ...values) {
 ...
 * @return 1/0
 */
RedisService.prototype.srem = async function (key, ...values) {
 ...
 * @return 1/0
 */
RedisService.prototype.sismember = async function (key, item) {
 ...
 * @return 返回集合包含的元素的数量
 */
RedisService.prototype.scard = async function (key) {
 ...
 * @return array(无序)/[]
 */
RedisService.prototype.smembers = async function (key) {
 ...
 * @return 返回被移除的元素
 */
RedisService.prototype.spop = async function (key) {
 ...
 * @return 列表/[]
 */
RedisService.prototype.srandmember = async function (key, num) {
 ...
 * @return 1/0
 */
RedisService.prototype.smove = async function (sourceKey, destKey, item) {
 ...
 * @return 包含差集成员的列表
 */
RedisService.prototype.sdiff = async function (key, ...keys) {
 ...
 * @return 结果集中的元素数量
 */
RedisService.prototype.sdiffstore = async function (destKey, key, ...keys) {
 ...
 * @return 包含交集成员的列表
 */
RedisService.prototype.sinter = async function (key, ...keys) {
 ...
 * @return 结果集中的元素数量
 */
RedisService.prototype.sinterstore = async function (destKey, key, ...keys) {
 ...
 * @return 包含并集成员的列表
 */
RedisService.prototype.sunion = async function (key, ...keys) {
 ...
 * @return 结果集中的元素数量
 */
RedisService.prototype.sunionstore = async function (destKey, key, ...keys) {
 ...
 * @return 
 */
RedisService.prototype.zadd = async function (key, ...scoreMember) {
 ...
 * @return 
 */
RedisService.prototype.zrem = async function (key, ...member) {
 ...
 * @return 有序集的元素个数
 */
RedisService.prototype.zcard = async function (key) {
 ...
 * @return 变化后的值
 */
RedisService.prototype.zincrby = async function (key, incr, member) {
 ...
 * @return 分数
 */
RedisService.prototype.zscore = async function (key, member) {
 ...
 * @return 成员数量
 */
RedisService.prototype.zcount = async function (key, min, max) {
 ...
 * @return 排名
 */
RedisService.prototype.zrank = async function (key, member) {
 ...
 * @return 排名
 */
RedisService.prototype.zrevrank = async function (key, member) {
 ...
 */
RedisService.prototype.zrange = async function (key, from, to, withscores) {
 ...
 * @return [member,member1,member2,...]
 */
RedisService.prototype.zrevrange = async function (key, from, to, withscores) {
 ...
 * @return [member,member1,member2,...]
 */
RedisService.prototype.zrangebyscore = async function (key, min, max, offset, count, withscores) {
 ...
 * @return [member,member1,member2,...]
 */
RedisService.prototype.zrevrangebyscore = async function (key, max, min, offset, count, withscores) {
 ...
 * @return 1(新增)/0(更新)
 */
RedisService.prototype.hset = async function (key, field, value) {
 ...
 * @return value/null
 */
RedisService.prototype.hget = async function (key, field) {
 ...
 * @return OK
 */
RedisService.prototype.hmset = async function (key, ...fieldValue) {
 ...
 */
RedisService.prototype.hmget = async function (key, ...field) {
 ...
 * @return N/0
 */
RedisService.prototype.hdel = async function (key, ...field) {
 ...
 * @return N/0
 */
RedisService.prototype.hlen = async function (key) {
 ...
 * @return 1/0
 */
RedisService.prototype.hexists = async function (key, field) {
 ...
 * @return 列表/[]
 */
RedisService.prototype.hkeys = async function (key) {
 ...
 * @return 列表/[]
 */
RedisService.prototype.hvals = async function (key) {
 ...
 */
RedisService.prototype.hgetall = async function (key) {
 ...
 * @return 变更后的值
 */
RedisService.prototype.hincrby = async function (key, field, incr) {
 ...
 * @return 变更后的值
 */
RedisService.prototype.hincrbyfloat = async function (key, field, incr) {
 ...
 * 关闭redis服务
 */
RedisService.prototype.shutdown = function () {
