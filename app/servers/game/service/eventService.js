...
bearcat.extend('game_EventService', 'logic_BaseService');
...
EventService.prototype.getMaxListeners = function () {
    this.eventEmitter.getMaxListeners();
};
...
EventService.prototype.listeners = function (event) {
    this.eventEmitter.listeners(makeKey(event));
};
...
EventService.prototype.rawListeners = function (event) {
    this.eventEmitter.rawListeners(makeKey(event));
};
...
EventService.prototype.listenerCount = function (event) {
    this.eventEmitter.listenerCount(makeKey(event));
};
