...
Protobuf.encode2Bytes = function(key, msg){
	...
	if(!buffer || !buffer.length){
		logger.error(`encode msg failed! key : ${JSON.stringify(key)}, msg: ${JSON.stringify(msg)}`);
		return null;
	}
...
Protobuf.decode = function(key, msg){
	const decodeMsg = decoder.decode(key, msg);
	if (!decodeMsg) {
		logger.error(`decode msg failed! key : ${JSON.stringify(key)}, msg: ${JSON.stringify(msg)}`);
	}
	return decodeMsg;
};
